...
public class serviceremboursement {
   ...
   Connection cnx=DataSource.getInstance().getConnection();
        ...
        try {
            String req = "INSERT INTO `remboursement`( `montant_rembour`, `date_rembour`) VALUES ('"+re.getMontant_rembour()+"','"+re.getDate_rembour()+"')";
        ...
        try {
            ...
            while (rs.next()) {
                remboursement E = new remboursement();
                   ...
                   E.setId_rembour(rs.getInt(1));
                   E.setMontant_rembour(rs.getInt(2));
